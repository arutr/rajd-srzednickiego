...
class Rajd_Srz_Stations_List_Table extends WP_List_Table
{
    /**
     * @inheritDoc
     */
    ...
    {
        $url = add_query_arg(
            ['action' => 'delete_station', 'id' => $item['ID']],
            menu_page_url('stations', false)
        );
    ...
    {
        $url = add_query_arg('id', $item['ID'], menu_page_url('station-edit', false));
    ...
    public function prepare_items()
    {
        ...
        $sql = "SELECT $column_keys FROM rajd_srz_stations WHERE 1=1 $search"
        ...
        $count = $wpdb->get_var("SELECT COUNT(id) FROM rajd_srz_stations WHERE 1=1 {$search};");
